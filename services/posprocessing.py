...
def valida_nome(imagem, top_left, w, h, texto):
    ...
    if quantidade_nomes > 2:
        ...
        nova_roi = imagem[
            top_left[1] - 10 : top_left[1] + h + 10, top_left[0] : top_left[0] + 2 * w
        ]
    else:
        nova_roi = imagem[
...
def valida_rg(imagem, top_left, w, h, texto):
    if texto[-1].isalpha():
        ...
        nova_roi = imagem[
            top_left[1] - 10 : top_left[1] + h + 10, top_left[0] : top_left[0] + 460
        ]
...
def valida_cpf(imagem, top_left, w, h, n_cpf):
    ...
    if tamanho == 11:
        ...
        nova_roi = imagem[
            top_left[1] - 10 : top_left[1] + h + 10, top_left[0] : top_left[0] + 280
        ]
